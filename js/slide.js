...
define('slide',function(require, exports, module) {
    ...
    seajs.importStyle(
        '.slide{position:relative;overflow:hidden;-ms-touch-action:none;touch-action:none}.slide_wrap{position:absolute;width:100%;height:100%;overflow:hidden;*zoom:1}.slide_c{float:left;top:0;left:0;width:100%;height:100%;overflow:hidden;z-index:1}.slide_nav{position:absolute;z-index:8}.slide_nav .arrs{position:absolute;cursor:pointer;z-index:9;moz-user-select:-moz-none;-moz-user-select:none;-o-user-select:none;-webkit-user-select:none;-ms-user-select:none;user-select:none}.arrs.unable{cursor:default}'
        ,module.uri)
...
//@ sourceURL=http://www.ourhearty.com/resources/modules/slide.js